      ...
      <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: T.radius, padding: 24, marginBottom: 20, boxShadow: T.shadow }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 13, color: T.inkMuted }}>Keywise Pro — \$49/month</div>
          </div>
          {subscriptionStatus && (
            <span style={{
        ...
        {(!subscriptionStatus || !stripeCustomerId) && (
          <>
            ...
            <div style={{ fontSize: 12, color: T.inkMuted }}>Free forever for 1-2 units · Pro $49/month · Cancel anytime</div>
          </>
        )}
