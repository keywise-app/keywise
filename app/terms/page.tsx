      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <div style={{ fontSize: 15, color: INK_MID, lineHeight: 1.8 }}>
          ...
          <Section title="4. Payment Terms">
            <p><strong>Free Plan:</strong> Keywise offers a free tier for 1 unit with core features including lease tracking, document storage, AI communications, and a tenant portal. No credit card is required.</p>
            <p><strong>Pro Plan:</strong> $49/month, billed monthly. The Pro plan includes unlimited units, online rent collection, payment reminders, maintenance tracking, and priority support.</p>
