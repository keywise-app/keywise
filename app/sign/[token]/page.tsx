            ...
            {docData.inspection && (
              <div style={{ background: '#fff', border: `1px solid ${T.border}`, borderRadius: T.radius, padding: 24, marginBottom: 20, boxShadow: '0 2px 12px rgba(15,52,96,0.08)' }}>
                ...
                {(docData.inspection.rooms || []).length > 0 && (
                  <div style={{ background: T.tealLight, border: `1px solid ${T.teal}`, borderRadius: 8, padding: '10px 14px', marginBottom: 14, display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                    <span style={{ fontSize: 14, color: T.teal, flexShrink: 0 }}>✦</span>
                    <p style={{ margin: 0, fontSize: 13, color: '#0F3460', lineHeight: 1.6 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        {room.condition && (
                          <span style={{
                            ...
                            background: T.tealLight, color: T.teal, letterSpacing: '0.02em',
                          }}>✦ AI-assessed</span>
                        )}
                      </div>
                    </div>
                ...
                {docData.inspection.report_text && (
                  <div style={{ background: '#F8FAFF', borderRadius: 10, padding: 14, marginTop: 12, border: `1px solid ${T.border}` }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: T.inkMuted, textTransform: 'uppercase' }}>AI Summary</div>
                      <span style={{
                        fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 20,
                        background: T.tealLight, color: T.teal, letterSpacing: '0.02em',
                      }}>✦ AI-assessed</span>
                    </div>
                    <div style={{ fontSize: 13, color: T.navy, lineHeight: 1.6 }}>{docData.inspection.report_text}</div>
                  </div>
                )}
              </div>
            )}
