    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#fff', color: INK, minHeight: '100vh' }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div className="pricing-grid">
          {/* Free */}
          <div className="pricing-card-free" style={{ background: SURFACE, borderRadius: 20, padding: '32px 28px', border: `1px solid ${BORDER}`, boxShadow: '0 2px 8px rgba(15,52,96,0.06)' }}>
          ...
          {/* Pro */}
          <div className="pricing-card-pro" style={{ background: N, borderRadius: 20, padding: '32px 28px', border: `2px solid ${TEAL}44`, boxShadow: `0 8px 32px rgba(15,52,96,0.2)`, position: 'relative', overflow: 'hidden' }}>
